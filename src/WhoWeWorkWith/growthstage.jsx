...
const GrowthStage = React.memo(() => {
  ...
  const understandingItems = [
    'The point where spreadsheets and a part-time bookkeeper stop being enough',
    'Investor, lender, or board reporting requirements you have not needed before',
    'Cash flow pressure that comes with scaling faster than your systems',
    'The jump from "compliant" to "strategically managed" finances',
  ];
  ...
  const processSteps = [
    {
      ...
      text: 'Where you are now, and what\'s actually driving the pressure on your finances.',
    },
    {
      step: '2',
      title: 'Right-size the support',
      text: 'Exactly what you need at this stage - not over-built, not under-resourced.',
    },
    {
      step: '3',
      title: 'Build for what is next',
      text: 'Systems and reporting that won\'t need replacing again in 12 months.',
    },
    {
      step: '4',
      title: 'Scale with you',
      text: 'As you grow, the level of support flexes with you.',
    },
  ];
      ...
      <main className="assurance-page">
        <section className="assurance-hero">
          ...
          <div className="assurance-hero-content">
            <h1 className="assurance-hero-title">Financial structure that keeps pace with your growth.</h1>
            <p className="assurance-hero-subtitle">
              Accounting, audit, and strategic support built for SMEs that have outgrown the basics - without the overhead of a big firm.
            </p>
            <button
              type="button"
            ...
            <div className="row g-4 align-items-center assurance-why-row">
              ...
              <div className="col-lg-6">
                <div className="assurance-why-copy">
                  <p className="assurance-pill assurance-pill-left">Why FinReach for Growth Stage</p>
                  <h2>CFO-level thinking, without CFO-level overhead.</h2>
                  <p>
                    Don has spent over 25 years advising organisations through growth, funding pressure, and the financial decisions that determine whether they scale successfully or stall.
                  </p>
                  <p>
                    Don has spent over 25 years advising organisations through growth, funding pressure, and the financial decisions that determine whether they scale successfully or stall.
                  </p>
        ...
        <section className="new-auditing-final-cta" style={{ backgroundImage: `url(${ctaBg})` }}>
          ...
          <div className="container">
            <div className="new-auditing-final-cta-content">
              <h2>Ready to scale with financial confidence?</h2>
